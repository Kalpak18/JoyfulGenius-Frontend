        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {filteredChapters.map((chapter, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white border rounded-xl shadow hover:shadow-md transition flex flex-col p-3 sm:p-4 text-sm sm:text-base max-h-[260px] sm:max-h-full"
              >
                {videoId ? (
                  playingIndex === index ? (
                    <iframe
                    ...
                    <div
                      ...
                      className="aspect-video overflow-hidden rounded-xl cursor-pointer border-2 border-gray-300 hover:border-blue-500 transition"
                    >
                      <img
                        src={thumbnail}
                        alt={chapter.title}
