...
// import { Home, BookOpen, User, LogIn, LogOut, Menu, X, ChevronLeft, ChevronRight } from "lucide-react";
...
//           {!loading && (
//             role === "user" ? (
//               <Link to="/dashboard" className={`flex flex-col items-center p-2 ${isActive('/dashboard') ? 'text-amber-400' : 'text-white'}`} onClick={() => setIsOpen(false)}>
//                 <User size={20} />
//                 <span className="text-xs mt-1">Profile</span>
//               </Link>
//             ) : role === "admin" ? (
//               <button onClick={() => { handleLogout(); setIsOpen(false); }} className="flex flex-col items-center p-2 text-white">
//                 <LogOut size={20} />
//                 <span className="text-xs mt-1">Logout</span>
//               </button>
//             ) : (
//               <Link to="/admin/login" className={`flex flex-col items-center p-2 ${isActive('/admin/login') ? 'text-amber-400' : 'text-white'}`} onClick={() => setIsOpen(false)}>
//                 <LogIn size={20} />
        ...
        <div className="flex justify-around py-2">
          ...
          {!loading && (
            isUser ? (
              ...
              <button onClick={() => { logout(); setIsOpen(false); }} className="flex flex-col items-center p-2 text-white">
                <LogOut size={20} />
                <span className="text-xs mt-1">Logout</span>
              </button>
            ) : (
