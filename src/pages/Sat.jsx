...
const Sat = () => {
  ...
  const subjects = [
    { name: "Mathematics", path: "/Mathematics", image: mathsImage },
    { name: "Science", path: "/science", image: scienceImage },
    { name: "Geography", path: "/Geography", image: geographyImage },
    { name: "History", path: "/social-studies", image: historyImage },
  ];
