...
const PaymentPage = () => {
  ...
  const content = {
    mr: {
      ...
      afterPayment: "पेमेंट झाल्यानंतर कृपया UPI क्रमांक किंवा स्क्रीनशॉट WhatsApp वर पाठवा:",
      whatsAppButton: "WhatsApp वर पाठवा",
      // waitMsg: "कृपया प्रशासक पेमेंटची पुष्टी करेपर्यंत प्रतीक्षा करा (जास्तीत जास्त ६ तास)",
      waitMsg: "पेमेंट केल्यानंतर थोड्याच वेळात मास्टर टेस्ट सुरू होईल. ( जास्तीत जास्त 6 तास )",
      screenshotMsg: "कृपया स्क्रीनशॉटसोबत आपले नोंदणी केलेले नाव पाठवा",
      goBack: "मागे जा",
